...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if(file) {
            ...
            // image upload
            try {
                const imageUpload = await axios.post("http://localhost:5000/upload",data)
        ...
        // post upload
        try {
            const res = await axios.post("http://localhost:5000/posts/create",post,{withCredentials:true})
